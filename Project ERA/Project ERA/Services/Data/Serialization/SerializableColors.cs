...
{
    [Serializable]
    public class SerializableColors : SerializableDatabaseContent<SerializableColors>
    {
        /// <summary>
        ...
        internal static Int32 Deserialize()
        {
            ...
            if (loaded == null)
                Logger.Notice("Colors could not be loaded, because an exception was thrown while deserializing.");
            else
            {
