...
namespace ERAServer.Data
{
    internal partial class GeneralCache<K, T>
    {
        ...
        internal static Boolean AddCache(K key, T value)
        {
            _cacheLock.EnterWriteLock();
            Boolean result = _cache.Enqueue(key, value);
        ...
        internal static Boolean RemoveCache(K key)
        {
            _cacheLock.EnterWriteLock();
            Boolean result = _cache.Remove(key);
            _cacheLock.ExitWriteLock();
            return result;
        }
        ...
        /// <returns></returns>
        internal static T UpdateCache(K key, T value)
        {
