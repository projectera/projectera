...
namespace ERAAuthentication.SRP6
{
    internal partial class HandShake
    {
        ...
        public SRPVerification KeyFromResponse(SRPResponse response)
        {
            ...
            // Private key x
            NetBigInteger x = SRPFunctions.Calcx(response.Salt, _request.Username.ToLower(), _cache.UserData);
            ...
            _verification = new SRPVerification(SRPFunctions.CalcM(N, g, _request.Username.ToLower(), response.Salt, _cache.A, response.B, _cache.K));
        ...
        private void VerificationOfPassiveParty(SRPVerification verification)
        {
            ...
            Logger.Verbose("It was Claire whom received SRPVerification");
